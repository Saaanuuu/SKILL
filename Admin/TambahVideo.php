...
if (isset($_POST["submit"])) {
  ...
  $query = "UPDATE materi_elearning SET 
      judul_videoElearning = '$judul_videoElearning',
      link_videoElearning = '$link_videoElearning'
      WHERE id_materiElearning = '$id_materiElearning'";

  $sql = mysqli_query($koneksi, $query);

  if ($sql) {
    header("Location: Isi Materi-Elearning.php?id_materi=" . $id_materi);
  } else {
    echo "<script>
